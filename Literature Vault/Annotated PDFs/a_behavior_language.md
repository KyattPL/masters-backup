...
>```
>%%
>*%%PREFIX%%e enclosing behavior to fail.%%HIGHLIGHT%% ==Subgoal steps establish goals that must be accomplished  in  order  to  accomplish  the  behavior== %%POSTFIX%%.  The  pursuit  of  a  subgoal*
