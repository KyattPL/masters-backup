...
proponują wykorzystanie LLM jako podstawę dla
...
W pracy "Generative Agents: Interactive Simulacra of Human Behavior" (2023)\cite{ai_town_ref} autorzy przedstawiają koncepcję
generatywnych agentów, które wykorzystują duże modele językowe do symulacji wiarygodnych zachowań
ludzkich. Architektura agenta opiera się na trzech głównych komponentach: strumieniu pamięci, refleksji
...
agenta. Integracja tych elementów z dużymi modelami językowymi umożliwia agentom generowanie spójnych,
długoterminowych narracji, które odzwierciedlają dynamicznie zmieniające się doświadczenia i środowisko.
Praca ta otwiera nowe perspektywy dla tworzenia agentów, które mogą być użyteczne w różnorodnych
aplikacjach, od gier po symulacje społeczne i treningi interpersonalne\cite{ai_town_ref}.