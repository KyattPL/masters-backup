...
\begin{figure}
	\centering\includegraphics[width=.6\textwidth]{imgs/swarm-network}
...
\begin{figure}[ht]
	...
	\begin{minipage}[b]{0.45\textwidth}
		\centering\includegraphics[width=0.9\textwidth]{imgs/kotek} % left figure
		\caption{Lewy rysunek}\label{fig:lewy}
	\end{minipage}
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{imgs/swarm-network} % right figure
