...
\begin{figure}[h]
	\includegraphics[width=\textwidth]{ch_1_1_2_lis_2.png}
	\caption{Life is Strange (2015)}
	\centering
	\label{fig:ch1_3_1_wheel}
\end{figure}

\subsubsection*{Precyzjne / nieprecyzyjne}
...
\begin{figure}[h]
	\includegraphics[width=\textwidth]{ch1_3_1_emotions.png}
	\caption{Fragment spisu ikon dialogowych - "Dragon Age: Inquisition" (2014)}
	\centering
