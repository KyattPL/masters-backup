...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{ch4_2_adam_knowledge.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{ch4_2_adam_personality.png}
...
uczestnika podania podstawowych informacji demograficznych, a następnie gry w wersji bez AI. Po 
zakończeniu tej sesji, uczestnik wypełniał kwestionariusz oceniający doświadczenie gracza (GEQ). 
Następnie przechodził do gry w wersji z włączoną sztuczną inteligencją i ponownie wypełniał ten 
sam kwestionariusz GEQ.
...
Na początku każdej sesji uczestnicy wypełniali kwestionariusz z danymi demograficznymi. Obejmował 
...
kwestionariusza Game Experience Questionnaire (GEQ). Uczestnicy oceniali swoje wrażenia z gry w 
skali od 1 do 5 dla różnych aspektów takich jak immersja, wyzwanie, kompetencje, frustracja itp.  
Kwestionariusz GEQ wypełniany był dwukrotnie - po zakończeniu sesji z wersją gry bez sztucznej 
inteligencji oraz po wersji z włączoną AI.
