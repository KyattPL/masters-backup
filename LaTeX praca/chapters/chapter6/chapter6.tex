...
(konkretne dane umieszczone są w dodatku \ref{appendix:A}).
...
wykorzystane do utworzenia postaci Adama (reszta postaci jest widoczna w dodatku \ref{appendix:A}) oraz
